...
function Select(props) {
    ...
    useEffect(() => {
        const fetchDataStarter = async () => {
          try {
            const responseDataFood = await Data.getAll(
              "https://www.themealdb.com/api/json/v1/1/search.php?s=" + props.dataFromSelect
            );
        ...
        fetchDataStarter();
    }, [props.dataFromSelect]);
    return (
        <div className="all-food">
          <div className='container'>
              <div className='starter'>
              <h2>{Array.isArray(dishes) && dishes != "" ? dishes[0].strCategory !== undefined ? dishes[0].strCategory : props.dataFromSelect : props.dataFromSelect}</h2>
